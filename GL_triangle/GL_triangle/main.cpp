...
int main(void){
    ...
    GLuint programID = LoadShaders( "/Users/shuya/SKashi/OpenGL/GL_exercise/GL_triangle/GL_triangle/SimpleVertex.v", "/Users/shuya/SKashi/OpenGL/GL_exercise/GL_triangle/GL_triangle/SimpleFragment.f" );
